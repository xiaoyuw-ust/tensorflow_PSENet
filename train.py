...
def tower_loss(images, seg_maps_gt, training_masks, reuse_variables=None):
    ...
    if reuse_variables is None:
        ...
        tf.summary.image('seg_map_1_gt', seg_maps_gt[:, :, :, 1:2] * 255)
        tf.summary.image('seg_map_1_pred', seg_maps_pred[:, :, :, 1:2] * 255)
        tf.summary.image('seg_map_2_gt', seg_maps_gt[:, :, :, 2:3] * 255)
        tf.summary.image('seg_map_2_pred', seg_maps_pred[:, :, :, 2:3] * 255)
        tf.summary.image('seg_map_3_gt', seg_maps_gt[:, :, :, 3:4] * 255)
        tf.summary.image('seg_map_3_pred', seg_maps_pred[:, :, :, 3:4] * 255)
        tf.summary.image('seg_map_4_gt', seg_maps_gt[:, :, :, 4:5] * 255)
        tf.summary.image('seg_map_4_pred', seg_maps_pred[:, :, :, 4:5] * 255)
        tf.summary.image('seg_map_5_gt', seg_maps_gt[:, :, :, 5:6] * 255)
        tf.summary.image('seg_map_5_pred', seg_maps_pred[:, :, :, 5:6] * 255)
